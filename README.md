...
How to Use
Export from Notion: Go to your top-level Notion page, click Export, choose HTML, and ensure Include subpages is toggled on.

Install Requirements: Make sure you have Python installed, then open your terminal or command prompt and run:
pip install beautifulsoup4

Run the Script: Double-click the merge_notion.py file (or run it from your terminal).

Select Files: Two pop-up windows will appear. Select your downloaded Notion ZIP file in the first, and choose where you want to save your new combined HTML file in the second.
